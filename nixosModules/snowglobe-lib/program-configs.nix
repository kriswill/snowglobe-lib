...
let
  ...
  cfg = config.snowglobe-lib.program-configs;
in
{
  options.snowglobe-lib.program-configs.enable = lib.mkEnableOption ''
    Snowglobe-Lib's custom program configurations and package modifications
  '';
