...
let
  cfg = config.snowglobe-lib.minecraft-server;
...
in
{
  options.snowglobe-lib.minecraft-server = {
    enable = lib.mkEnableOption "Snowglobe-Lib's configuration for a minecraft server";
